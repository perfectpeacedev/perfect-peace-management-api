...
Teacher.hasMany(EmployeeSalary, { as: 'employeeSalaries', foreignKey: 'teacherId' });
...
Parent.hasMany(Student, { as: 'student', foreignKey: 'parentId' });
...
Student.hasMany(StudentResult, { as: 'studentResults', foreignKey: 'studentId' });
...
TeachersWeeklyReport.belongsTo(Teacher, { as: 'teacher', foreignKey: 'teacherId' });
Teacher.hasMany(TeachersWeeklyReport, { as: 'teachersWeeklyReports', foreignKey: 'teacherId' });

TotalAttendance.belongsTo(Student, { as: 'student', foreignKey: 'studentId' });
Student.hasMany(TotalAttendance, { as: 'totalAttendances', foreignKey: 'studentId' });
